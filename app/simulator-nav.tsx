...
export function LabHeader({active}:{active:'home'|'body'|'sleep'|'wrist'|'research'|'manual'}){return <L as="header" className="topbar portal-topbar"><L as="a" className="brand" href="/" aria-label="SOMA 시뮬레이터 홈"><L as="span" className="brand-mark"><Activity size={23}/></L><L as="span">SOMA<L as="span" className="brand-period">.</L></L><L as="span" className="brand-sub">DIGITAL HUMAN LAB</L></L><SimulatorNav active={active}/><div className="header-preferences"><RenderQualityControl/><LanguageSwitch/></div><L as="span" className="portal-research-badge"><L as="i" className="status-dot"/> RESEARCH WORKSPACE</L></L>}
