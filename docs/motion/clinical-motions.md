...
전신 트윈의 움직임 메뉴에 오른손 인사(Wave hello), 춤추기(Dance)를 추가했다. 인사는 CMU 141_16의 3–290 프레임, 춤은 CMU 103_03 Charleston의 134–368 프레임을 사용한다. 생성 스크립트는 `scripts/build-expression-mocap.mjs`, 짧은 리그 전용 데이터는 `lib/expression-mocap-data.js`다. 출처와 조건은 [모션 출처](../../public/motions/ATTRIBUTION.md)에 기록했다.
