...
가슴 패치 이동은 직접 드래그·피부 클릭·좌우/높이 슬라이더·개별 초기화를 지원한다. 패치 전체를 실제 외피 곡면에 부착하며 위치는 내보내기에 기록한다. 위치별 신호 감도 결합은 아직 구현하지 않았다. 발가락 근육/힘줄의 손 본 오분류와 팔 신경의 몸통 연결, 혈관의 불연속 흉곽 연결을 수정했다. 춤은 CMU 103_03 Charleston 재즈(31–423 프레임, 3.2666536초)이며 체적 보정표와 손목 브리지를 재생성했다.
