...
export function taskState(motion,elapsed){
 ...
 if(motion==='lie'){
  ...
  return {...base,seat:prep,arm:prep,recline:sideLower,legLift,sideLower,extend,roll,effort,activity:effort*.7,repetitions:t>=14?1:0,complete:t>=14,stage:t<2?'침대 왼쪽 중간에 걸터앉기':t<3.4?'팔을 몸 쪽으로 모으기':t<7.2?'머리맡으로 옆눕기 · 다리 올리기':t<9.5?'옆으로 누워 다리 펴기':t<12?'등으로 돌아눕기':t<14?'팔을 침대 위로 내려놓기':'누운 자세 · 안정 호흡'};
 }
 if(motion==='grip'){
