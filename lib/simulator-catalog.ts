export const simulators=[
 ...
 {id:'wrist',href:'/simulators/wrist',number:'02',title:'손·손목 바이오센싱',en:'RADIAL PULSE & OPTICAL SENSING',image:'/thumbnails/wrist.jpg',alt:'손목 피부 단면의 요골동맥, 피하지방, 힘줄과 뼈',description:'요골동맥 위의 정전용량 배열을 배치하고, 채널 결합·맥파 지연·손가락 광학 신호를 비교합니다.',features:['손목 패치 배치 · 채널 히트맵','MRC · 지연 보상 · PTT/PWV 연구','검지 Red/IR · SpO₂ 합성 모델','혈압 추정 연구 · 접촉·조직 변위'],status:'해부학 · 조직 역학 연결',action:'손·손목 실험 열기'},
] as const;
