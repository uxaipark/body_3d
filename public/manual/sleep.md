...
패치의 곡면은 실제 외피 삼각형에 부착되며 호흡과 체위 변화에 따라 같은 피부 위치를 유지한다. 위치는 내보내기 JSON의 patchPlacement에 atlas-bind 좌표(m, X는 환자의 왼쪽, Y는 위쪽)로 기록한다. 이 조절은 부착 위치 시각화이며, 위치별 전기장·CAP·ECG 감도 변화는 아직 신호 모델에 연결하지 않는다.
