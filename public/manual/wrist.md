...
Radial Artery Digital Twin 카드 맨 위의 **성능 모드**에서 자동·저사양·균형·고화질을 선택합니다. 카드를 접어도 선택기는 남습니다. 전신·수면 화면과 선택값을 공유하며 브라우저에 저장합니다. 아바타에는 전신과 같은 정밀도 전환을 적용하고, 손목·피부 단면에는 해상도와 30/60FPS 상한을 적용합니다. 손목의 세부 해부학 구조는 유지합니다. 고화질에서는 손목 그림자도 켭니다. 자동은 기기 사양과 재생 성능에 따라 낮춥니다. 신호 생성·수집·혈압 추정 설정은 바뀌지 않습니다.
