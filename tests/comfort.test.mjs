import test from 'node:test';import assert from 'node:assert/strict';import *as T from 'three';import {comfortRegion,comfortCover,applyComfortMask} from '../lib/comfort.ts';import {HumanRig} from '../lib/rig.ts';
